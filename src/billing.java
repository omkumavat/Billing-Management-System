...
public class billing extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            if(rs.next())
            {
                ...
                int quantity= parseInt(jTextField13.getText());
                if(stockquantity>=quantity)
                {
                    arrpid.add(parseInt(pid));
    ...
    private void jTextField9ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this,
                    "Invalid Product ID: must be an integer",
                    "Input Error",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }

        String sql = "SELECT pid, name, price, quantity, description FROM product WHERE pid = ?";
            ...
            try (ResultSet rs = pst.executeQuery()) {
                if (rs.next()) {
                    ...
                    if (qty > 0) {
                        ...
                        jTextField9.setText(rs.getString("pid"));
                        jTextField10.setText(rs.getString("name"));
                        jTextField11.setText(rs.getString("price"));
                        // if you have a field for quantity:
                        // jTextField13.setText(String.valueOf(qty));
                        jTextField12.setText(rs.getString("description"));
                    } else {
                        JOptionPane.showMessageDialog(this,
                                "Product \"" + rs.getString("name") + "\" is out of stock!",
                                "Out of Stock",
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(a==0)
        {
            ...
            try
            {
                ...
                ResultSet rs1=st1.executeQuery("select id from buyer where Contact_no = " + jTextField2.getText());
                if(rs1.next())
                {
            ...
            String path="D:\\Billing-Management-System\\" + Name + "_" + Date + ".pdf";
            com.itextpdf.text.Document doc=new com.itextpdf.text.Document();
            try
            {
                PdfWriter.getInstance(doc, new FileOutputStream(path));
                doc.open();
                Paragraph p1= new Paragraph("--------------------------------------WELCOME TO OM KUMAVAT PRODUCTS---------------------------------------\n");
                Paragraph p2=new Paragraph("-------------------------------Please Contact For Further Enquiry :(+91)9209115091 --------------------\n\n");
                doc.add(p1);
                doc.add(p2);
    ...
    private void jTextField6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField6ActionPerformed
        // TODO add your handling code here:
        int paidamount= parseInt(jTextField6.getText());
